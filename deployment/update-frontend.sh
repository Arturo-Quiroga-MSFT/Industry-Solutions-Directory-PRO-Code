...
FRONTEND_IMAGE_TAG="v2.4-portal-images"
...
echo "  ✨ Portal hero banner images"
echo "  🏢 Updated branding: Partner Solutions Directory"
echo "  💬 Technology-focused example questions"
echo "  🎯 Dual browsing support (Industry OR Technology)"
echo "  🖼️  Official Microsoft logo from portal"
echo "  📸 Hero image from actual ISD portal"
echo "  🌈 Enhanced descriptions and messaging"
echo ""
echo "Next Steps:"
